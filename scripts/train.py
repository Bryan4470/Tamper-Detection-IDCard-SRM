...
class Trainer:
    ...
    def train_epoch(self, epoch: int) -> Dict[str, float]:
        self.model.train()
        total_loss = total_cls = total_cb = 0.0
        ...
        for images, labels in pbar:
            ...
            with torch.cuda.amp.autocast(enabled=self.scaler is not None):
                ...
                loss_dict = self.criterion(out['logits'], out['cb_features'], labels)
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, epochs):
            ...
            logger.info(f"Train - Loss: {train_m['loss']:.4f}, Cls: {train_m['cls_loss']:.4f}, Cb: {train_m['cb_loss']:.4f}")
